            ...
            <div class="row">
                ...
                <div class="col-lg-8 v-center">
                    <ul class="footer-badges-">
                        <li><a href="#"><img src="{{ asset('asset/client/images/about/badges-a.png') }}" alt="badges"></a></li>
                        <li><a href="#"><img src="{{ asset('asset/client/images/about/badges-b.png') }}" alt="badges"></a></li>
                        <li><a href="#"><img src="{{ asset('asset/client/images/about/badges-c.png') }}" alt="badges"></a></li>
                        <li><a href="#"><img src="{{ asset('asset/client/images/about/badges-d.png') }}" alt="badges"></a></li>
                    </ul>
                </div>
            </div>
        </div>
