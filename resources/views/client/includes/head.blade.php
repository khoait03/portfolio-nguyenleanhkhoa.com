<head>
    <meta charset="utf-8"/>
    <title>Nguyễn Lê Anh Khoa &amp; Khoa - Daily</title>
    ...
    <!--website-favicon-->
    <link href="{{ asset('asset/client/favicon.png') }}') }}" rel="icon">
    <!--plugin-css-->
    ...
    <link href="{{ asset('asset/client/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('asset/client/css/darkmode.css') }}" rel="stylesheet">
</head>
